// General data info
TString CampaignName = "CTAGMoriond2017";
string CampaignNameString = "CTAGMoriond2017";
...
// Pt bins
int const nBinsCampaign = 4;
float MinPtCampaign, MaxPtCampaign;

float xPt[nBinsCampaign]  = /*{512.5}; /*/ {30.0, 42.5, 60.0, 135}; //bin center
float exPt[nBinsCampaign] = /*{487.5}; /*/ {5, 7.5, 10, 65};        //bin width
...
float TTbarPt[nBinsCampaign] = /*{0.01, 0.97, 0.01, 0.01};///*/{3962, 5436, 5025, 6405};
float TTbarSpectrumScale = /*1;//*/3962+ 5436+ 5025+ 6405;

//fit function for plots
TString FittingFunction = "[0]*x + [1]";
